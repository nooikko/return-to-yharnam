    ...
    <Section className='flex flex-col items-center bg-neutral-900 px-6 py-12 text-white md:px-12 xl:px-48'>
      ...
      <div className='flex w-full max-w-[1024px] flex-wrap-reverse justify-between'>
        <div className='mt-10'>
          ...
          <div className='text-gray-300'>Bloodborne&apos;s summon system can by finnicky.</div>
        ...
        <div className='mt-10'>
          ...
          <table className='mt-5 min-w-full divide-y divide-gray-300'>
            <thead>
              <tr>
                <th scope='col' className='py-3 pr-3 text-left text-xs font-medium uppercase tracking-wide text-gray-300 sm:pl-0'>
                  Password
                </th>
            ...
            <tbody className='divide-y divide-gray-200 text-sm'>
              <tr>
                ...
                <td className='px-3 py-2 text-gray-300'>Get involved! Team up with anyone</td>
              </tr>
              <tr>
                <td className='whitespace-nowrap py-2 pr-3  font-medium text-gray-100 sm:pl-0'>NEWBORN</td>
                <td className=' px-3 py-2 text-gray-300'>Team up with new characters</td>
              </tr>
              <tr>
                <td className='whitespace-nowrap py-2 pr-3 font-medium text-gray-100 sm:pl-0'>GREATONE</td>
                <td className=' px-3 py-2 text-gray-300'>Team up with pre-made characters</td>
              </tr>
            </tbody>
          </table>
        </div>
